...
<div class="box">
    ...
    <h1><a href="#menu-toggle" class="btn btn-default" id="menu-toggle"><i class="glyphicon glyphicon-chevron-left"></i></a> Dokter</h1>
    <h4>
        ...
        <table class="table table-striped table-bordered table-hover" id="dokter">
            <thead>
                <tr style="background-color: blue;">  
                    ...
                    <th><i class="glyphicon glyphicon-alert"></i> Spesialis</th>
