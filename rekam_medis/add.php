        ...
        <div class="col-lg-6 col-lg-offset-3">
            <form action="proses.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <!-- <a href="pilih.php" class="btn btn-primary btn-xs">Pilih</a> -->
                    <select multiple name="obat[]" id="obat" class="form-control" size="20" required>
                ...
                <div class="form-group">
                    <label for="tgl">Tgl. Periksa</label>
